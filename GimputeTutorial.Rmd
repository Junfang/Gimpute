...
[download the source code](https://github.com/Junfang/Gimpute/tarball/master)
```sh
wget --no-check-certificate https://github.com/Junfang/Gimpute/tarball/master -O Gimpute.tar.gz
## or ##
curl -L https://github.com/Junfang/Gimpute/tarball/master/ -o Gimpute.tar.gz

## Install ##
R CMD INSTALL Gimpute.tar.gz
```
