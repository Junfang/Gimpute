...
perl4snpsWithSamePos = paste0(GimputeDIR,"utilities//snpsWithSamePos.pl")
alignScript4compareName = paste0(GimputeDIR,"utilities/dataSetImpRefCompareName.pl ")
alignScript = paste0(GimputeDIR,"utilities/dataSetImpRefComparePos.pl ")


## required R functions
source(paste0(GimputeDIR, "R/1_function4infoUpdate.R"))
source(paste0(GimputeDIR, "R/2_function4QC.R")) 
source(paste0(GimputeDIR, "R/4_function4imputation.R"))
...
caseControl = FALSE #  global variable
